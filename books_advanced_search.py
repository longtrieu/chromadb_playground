...
# Function to load books data from JSON file
def load_books_data(file_path="books_data.json"):
  try:
...
def perform_book_search(collection):
  """Perform various types of book searches"""
...
def main():
  try:
    ...
    if not books:
      print("No books data loaded. Exiting.")
      return
